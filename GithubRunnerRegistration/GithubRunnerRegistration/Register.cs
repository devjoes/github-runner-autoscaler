...
namespace GithubRunnerRegistration
{
    public class Register
    {
        ...
        public async Task<Dictionary<string,string>> AddRunner(string name) => await this.RegisterRunner(name, new GetCredentials(), this.Run);
        ...
        public async Task<Dictionary<string, string>> RegisterRunner(string name, IGetCredentials getCreds, Action<ProcessStartInfo> run)
        {
